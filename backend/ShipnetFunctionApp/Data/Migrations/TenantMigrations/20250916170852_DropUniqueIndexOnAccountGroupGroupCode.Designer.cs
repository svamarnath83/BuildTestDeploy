...
namespace ShipnetFunctionApp.Data.Migrations.TenantMigrations
{
    ...
    [Migration("20250916170852_DropUniqueIndexOnAccountGroupGroupCode")]
    partial class DropUniqueIndexOnAccountGroupGroupCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShipnetFunctionApp.Data.Models.ActivityLog", b =>
                {
                    ...
                    b.Property<string>("ActivityImpactData")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("ShipnetFunctionApp.Data.Models.Registers.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("ExternalAccountNumber")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("external_account_number");

                    b.Property<string>("LedgerType")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("ledger_type");
            ...
            modelBuilder.Entity("ShipnetFunctionApp.Data.Models.Registers.AccountGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("IfrsReference")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("ifrs_reference");

                    b.Property<string>("Level1Code")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("level1_code");

                    b.Property<string>("Level1Name")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("level1_name");

                    b.Property<string>("Level2Code")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("level2_code");

                    b.Property<string>("Level2Name")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("level2_name");

                    b.Property<string>("Level3Code")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("level3_code");

                    b.Property<string>("Level3Name")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("level3_name");

                    b.Property<string>("SaftCode")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("saft_code");
            ...
            modelBuilder.Entity("ShipnetFunctionApp.Data.Models.Registers.Account", b =>
                {
                    b.HasOne("ShipnetFunctionApp.Data.Models.Registers.AccountGroup", "AccountGroup")
                        .WithMany()
