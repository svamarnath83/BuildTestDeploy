...
export default function EditCoAPage() {
  ...
  const handleSave = async () => {
    ...
    setIsLoading(true);
    try {
      console.log('Updating CoA account:', { id, ...formData });
  ...
  useEffect(() => {
    if (id) {
      // Simulate loading data for the account
      setFormData({
        groupCode: '1100',
        accountType: 'Asset',
        ...
        subType3: 'Cash',
        ledgerAccount: true,
        numberRangeStart: '110000',
        numberRangeEnd: '119999',
        dimensionCode: '110',
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              ...
              <span>{isLoading ? 'Updating...' : 'Update Account'}</span>
            </button>
          </div>
        </div>
